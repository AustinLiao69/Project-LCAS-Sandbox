...
#### 6.1.1 IncomeStatementRequest 類別規格
...
#### 6.1.2 TrendAnalysisRequest 類別規格
...
#### 6.2.1 IncomeStatementResponse 類別規格
...
#### 6.2.2 TrendAnalysisResponse 類別規格
...
#### 7.1.1 ReportValidationService 類別規格
...
#### 7.2.1 ReportSecurityService 類別規格
...
#### 9.1.2 ReportResponseFilter 類別規格
