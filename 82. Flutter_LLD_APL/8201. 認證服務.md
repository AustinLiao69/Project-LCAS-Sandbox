...
本節列出認證服務的所有 API 端點，嚴格遵循 [8020. API list.md](rag://rag_source_0) 和 [8088. API設計規範.md](rag://rag_source_2) 的規範。
...
### 5.3 Endpoint: `/auth/google-login`
...
### 5.6 Endpoint: `/auth/forgot-password`
...
### 5.7 Endpoint: `/auth/reset-password`
