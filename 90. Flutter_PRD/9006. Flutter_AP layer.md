...
**建立日期**: 2025-08-01  
**建立者**: LCAS PM Team  
**最後更新**: 2025-08-02 07:30:00 UTC+8
...
|----------|----------|-------------|----------|--------|
| **AuthService** | 認證授權管理 | 5個 (F001-F005) | 登入註冊、權限驗證 | 獨立服務 |
| **EntryService** | 記帳核心功能 | 4個 (F006-F009) | CRUD記帳記錄 | 依賴AuthService |
| **ProjectLedgerService** | 多帳本管理 | 6個 (F010-F015) | 專案帳本、成員管理 | 依賴AuthService |
| **BudgetService** | 預算管理 | 3個 (F016-F018) | 預算設定、進度追蹤 | 依賴EntryService |
| **CollaborationService** | 協作功能 | 3個 (F019-F021) | 共享、權限、同步 | 依賴ProjectLedgerService |
| **ReportService** | 報表功能 | 3個 (F022-F024) | 報表生成、分析、匯出 | 依賴EntryService |
| **SystemService** | 系統管理 | 8個 (F025-F032) | 備份、日誌、提醒 | 依賴所有服務 |
