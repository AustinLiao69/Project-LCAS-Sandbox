...
| API端點 | HTTP方法 | 功能描述 | 對應模組 |
|---------|----------|----------|----------|
| `GET /gamification/achievements` | GET | 取得成就 | 新增模組 |
| `GET /gamification/challenges` | GET | 取得挑戰 | 新增模組 |
| `POST /gamification/claim-reward` | POST | 領取獎勵 | 新增模組 |
| `GET /gamification/leaderboard` | GET | 排行榜 | 新增模組 |
| `POST /gamification/join-challenge` | POST | 加入挑戰 | 新增模組 |
| `GET /gamification/progress` | GET | 挑戰進度查詢 | 新增模組 |
...
| API端點 | HTTP方法 | 功能描述 | 對應模組 |
|---------|----------|----------|----------|
| `GET /notifications/settings` | GET | 取得通知設定 | 新增模組 |
| `PUT /notifications/settings` | PUT | 更新通知設定 | 新增模組 |
| `GET /notifications/list` | GET | 通知列表 | 新增模組 |
| `PUT /notifications/{id}/read` | PUT | 標記已讀 | 新增模組 |
