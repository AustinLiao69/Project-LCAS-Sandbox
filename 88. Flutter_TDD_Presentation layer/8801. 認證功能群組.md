...
- **創建者**: LCAS SA Team
- **最後更新**: 2025-08-12 10:00:00 +08:00 (台灣時間)
...
|---|----------|------|----------|----------|---------|
| 01 | AUTH_buildWelcomePage | V2.4.0 | 歡迎頁面UI | 建構歡迎頁面Widget | F004 |
| 02 | AUTH_buildModeSelector | V2.4.0 | 歡迎頁面UI | 建構模式選擇Widget | - |
| 03 | AUTH_buildLoginPage | V2.4.0 | 登入頁面UI | 建構登入頁面Widget | F002 |
| 04 | AUTH_buildOAuthButtons | V2.4.0 | 登入頁面UI | 建構OAuth登入按鈕 | F002 |
| 05 | AUTH_buildEmailLoginForm | V2.4.0 | 登入頁面UI | 建構Email登入表單 | F002 |
| 06 | AUTH_buildRegisterPage | V2.4.0 | 註冊頁面UI | 建構註冊頁面Widget | F001 |
| 07 | AUTH_buildRegistrationForm | V2.4.0 | 註冊頁面UI | 建構註冊表單Widget | F001 |
| 08 | AUTH_buildPasswordResetPage | V2.4.0 | 密碼重設UI | 建構密碼重設頁面 | F005 |
| 09 | AUTH_buildResetSteps | V2.4.0 | 密碼重設UI | 建構重設步驟Widget | F005 |
| 10 | AUTH_buildLogoutPage | V2.4.0 | 登出確認UI | 建構登出確認頁面 | F003 |
| 11 | AUTH_buildControllerModeUI | V2.4.0 | 四模式UI | 建構精準控制者介面 | - |
| 12 | AUTH_buildLoggerModeUI | V2.4.0 | 四模式UI | 建構紀錄習慣者介面 | - |
| 13 | AUTH_buildStruggleModeUI | V2.4.0 | 四模式UI | 建構轉型挑戰者介面 | - |
| 14 | AUTH_buildSleeperModeUI | V2.4.0 | 四模式UI | 建構潛在覺醒者介面 | - |
| 15 | AUTH_buildLoadingIndicator | V2.4.0 | 共用UI元件 | 建構載入指示器 | - |
