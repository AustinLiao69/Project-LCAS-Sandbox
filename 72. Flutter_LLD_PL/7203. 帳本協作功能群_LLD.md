...
本功能群**嚴格遵循0026文件PL-APL-BL三層架構對應**：
- **消費API服務**：透過APL.dart統一Gateway消費8104帳本管理服務API（14個端點）。81資料夾已廢棄，所有API轉發統一透過APL.dart處理。
...
**重要原則**：**透過APL.dart統一Gateway**消費8104帳本管理服務API，使用APL.dart提供的14個帳本管理API端點。81資料夾已廢棄，所有API轉發統一透過APL.dart處理。
...
**遵循規範**: 嚴格遵循0026、9502、0090、7001、0015、8088文件規範