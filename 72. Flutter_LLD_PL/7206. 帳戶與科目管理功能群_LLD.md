 ...
 * @update: 初版建立
 */
Future<ApiResponse<List<AccountModel>>> getWalletList(String ledgerId, String accountType);
```
 ...
 * @update: 初版建立
 */
Future<ApiResponse<AccountModel>> createWallet(String ledgerId, String walletName, String walletType, String currency);
```
 ...
 * @update: 初版建立
 */
Future<ApiResponse<AccountModel>> updateWallet(String walletId, String walletName, bool isActive);
```
