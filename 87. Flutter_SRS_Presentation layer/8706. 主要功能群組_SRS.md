...
|----------|----------|-------------|---------|----------|-------------|
| **P006** | 首頁儀表板 | **F009** | PUT /app/user/settings | PUT | 使用者設定管理 |
| **P006** | 首頁儀表板 | **F007** | GET /app/ledger/query | GET | 記帳記錄查詢 |
| **P007** | 快速記帳頁面 | **F006** | POST /app/ledger/entry | POST | 新增記帳記錄 |
| **P007** | 快速記帳頁面 | **F008** | GET /app/subjects/list | GET | 科目代碼管理 |
| **P008** | 詳細記帳頁面 | **F006** | POST /app/ledger/entry | POST | 完整記帳功能 |
| **P009** | 記帳歷史頁面 | **F007** | GET /app/ledger/query | GET | 記帳記錄查詢 |
| **P010** | 記帳編輯頁面 | **F006** | PUT /app/ledger/entry | PUT | 編輯記帳記錄 |
| **P011** | 科目管理頁面 | **F008** | GET /app/subjects/list | GET | 科目代碼管理 |
| **P012** | 詳細記帳頁面 | **F006** | POST /app/ledger/entry | POST | 詳細記帳功能 |
| **P013** | 搜尋頁面 | **F007** | GET /app/ledger/query | GET | 進階搜尋功能 |
| **P014** | 統計頁面 | **F007** | GET /app/ledger/query | GET | 資料統計分析 |
| **P015** | 帳本切換頁面 | **F015** | GET /app/ledgers/switch | GET | 多帳本切換 |

### 3.2 API使用統計
- **覆蓋API數量**：4個核心API（F006-F009, F015）
- **API使用率**：主要功能群組覆蓋率：12.5%（4/32個端點）
- **高頻API**：F006、F007（記帳核心功能）
- **整合複雜度**：中（集中於記帳功能）
- **注意事項**：本群組專注於核心記帳功能，其他功能群組將覆蓋剩餘API端點
