...
提供系統管理員監控和管理系統安全性的綜合控制台，包括安全策略設定、威脅監控、安全事件處理，以及系統安全狀態的即時監控，確保系統整體安全防護。

---

## 2. 使用者故事（User Story）

- 作為一位系統管理員，我希望能監控系統安全狀態，以便及時發現安全威脅
- 作為一位系統管理員，我希望能設定安全策略和規則，以便提高系統防護能力
- 作為一位系統管理員，我希望能檢視安全事件和告警，以便快速回應安全問題
- 作為一位系統管理員，我希望能管理安全認證設定，以便強化帳號安全
