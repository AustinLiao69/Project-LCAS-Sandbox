...
提供系統管理員管理用戶帳號的完整介面，包括用戶建立、編輯、停用、角色權限設定等功能，確保用戶帳號的有效管理和安全控制。

---

## 2. 使用者故事（User Story）

- 作為一位系統管理員，我希望能查看所有用戶的帳號資訊，以便了解用戶使用狀況
- 作為一位系統管理員，我希望能建立新的用戶帳號，以便為新用戶開通系統存取權限
- 作為一位系統管理員，我希望能修改用戶的基本資料和權限設定，以便維護帳號安全
- 作為一位系統管理員，我希望能停用或刪除用戶帳號，以便管理離職或不當使用的情況
