...
class GetDashboardRequest {
  final String? ledgerId; // Made optional to align with typical dashboard APIs
...
class QuickAccountingRequest {
  ...
  final String? ledgerId; // Made optional
...
class TransactionApiClientImpl implements TransactionApiClient {
  ...
  Future<ApiResponse<Transaction>> createTransaction(CreateTransactionRequest request) async {
    try {
      ...
      if (response.statusCode == 201) {
        ...
        return ApiResponse<Transaction>(success: true, data: transaction, statusCode: response.statusCode, message: responseData['message']);
      } else {
        // Handle potential error response body
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<Transaction>(success: false, error: e.toString(), statusCode: 500);
    }
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final transactions = (responseData['data'] as List)
            ...
            .toList();
        return ApiResponse<List<Transaction>>(success: true, data: transactions, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<List<Transaction>>(success: false, error: e.toString(), statusCode: 500);
    }
  }
  ...
  Future<ApiResponse<Transaction>> updateTransaction(String transactionId, UpdateTransactionRequest request) async {
    try {
      ...
      final response = await httpClient.put( // Assuming PUT for full update, use PATCH for partial
        url,
        headers: requestHeaders,
        body: jsonEncode(request.toJson()),
      );
  ...
  Future<ApiResponse<void>> deleteTransaction(String transactionId) async {
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) { // Success codes 200-299
        return ApiResponse<void>(success: true, statusCode: response.statusCode, message: 'Transaction deleted successfully');
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<void>(success: false, error: e.toString(), statusCode: 500);
    }
  }
  ...
  Future<ApiResponse<DashboardData>> getDashboardData(GetDashboardRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ApiResponse<DashboardData>(success: true, data: dashboardData, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<DashboardData>(success: false, error: e.toString(), statusCode: 500);
    }
  }
  ...
  Future<ApiResponse<DashboardData>> getStatistics(GetStatisticsRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ApiResponse<DashboardData>(success: true, data: statisticsData, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
  ...
  Future<ApiResponse<QuickAccountingResult>> quickAccounting(QuickAccountingRequest request) async {
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) { // Success codes
        final responseData = jsonDecode(response.body);
        final result = QuickAccountingResult(
          success: responseData['success'] ?? true, // Default to true on success code
          message: responseData['message'] ?? 'Quick accounting processed successfully',
          transaction: responseData['data'] != null ? Transaction.fromJson(responseData['data']) : null,
        );
        return ApiResponse<QuickAccountingResult>(success: true, data: result, statusCode: response.statusCode, message: result.message);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<QuickAccountingResult>(success: false, error: e.toString(), statusCode: 500);
    }
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final chartData = (responseData['data'] as List)
            .map((item) {
              // Ensure color is parsed correctly from hex string
              Color color = Colors.grey; // Default color
              if (item['color'] != null) {
                try {
                  color = Color(int.parse('0xFF${item['color'].toString().replaceAll('#', '')}'));
                } catch (e) {
                  print('Error parsing color: ${item['color']} - $e');
                }
              }
              return ChartData(
            ...
            .toList();
        return ApiResponse<List<ChartData>>(success: true, data: chartData, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<List<ChartData>>(success: false, error: e.toString(), statusCode: 500);
    }
  }
}
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final accounts = (responseData['data'] as List)
            ...
            .toList();
        return ApiResponse(success: true, data: accounts, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<List<Account>>(success: false, error: e.toString(), statusCode: 500);
    }
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final account = Account(
          ...
          type: responseData['data']['type'] as String,
          balance: (responseData['data']['balance'] as num).toDouble(),
        );
        return ApiResponse(success: true, data: account, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<Account>(success: false, error: e.toString(), statusCode: 500);
    }
  }
  ...
  Future<ApiResponse<Map<String, double>>> getAccountBalances(List<String> accountIds) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ApiResponse(success: true, data: balances, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<Map<String, double>>(success: false, error: e.toString(), statusCode: 500);
    }
  }
...
class CategoryApiClientImpl implements CategoryApiClient {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final categories = (responseData['data'] as List)
            .map((item) => Category.fromJson(item as Map<String, dynamic>)) // Cast item to Map
            .toList();
        return ApiResponse(success: true, data: categories, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<List<Category>>(success: false, error: e.toString(), statusCode: 500);
    }
  }
  ...
  Future<ApiResponse<Category>> getCategory(String categoryId) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        final category = Category.fromJson(responseData['data'] as Map<String, dynamic>); // Cast data to Map
        return ApiResponse(success: true, data: category, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
      }
    } catch (e) {
      return ApiResponse<Category>(success: false, error: e.toString(), statusCode: 500);
    }
  }
...
class TransactionRepositoryImpl extends TransactionRepository {
  ...
  Future<List<Transaction>> getTransactions({Map<String, dynamic>? filters}) async {
    try {
      final request = GetTransactionsRequest(
        ...
        startDate: filters?['startDate']?.toIso8601String(), // Ensure dates are ISO 8601 strings
  ...
  Future<Transaction?> getTransaction(String transactionId) async {
    try {
      // 首先檢查快取
      final cachedTransaction = _cache.firstWhereOrNull((t) => t.id == transactionId);
...
class CategoryRepositoryImpl extends CategoryRepository {
  ...
  Future<Category?> getCategory(String categoryId) async {
    try {
      // 首先檢查快取
      final cachedCategory = _cache.firstWhereOrNull((c) => c.id == categoryId);
...
class AccountRepositoryImpl extends AccountRepository {
  ...
  Future<Account?> getAccount(String accountId) async {
    try {
      // 首先檢查快取
      final cachedAccount = _cache.firstWhereOrNull((a) => a.id == accountId);
  ...
  static Future<Transaction> processFormSubmission(Map<String, dynamic> formData) async {
    ...
    final transaction = Transaction(
      ...
      date: formData['date'] != null
          ? DateTime.parse(formData['date'].toString()) // Ensure date is parsed correctly
          : DateTime.now(),
      createdAt: DateTime.now(), // 新增
      updatedAt: DateTime.now(), // 新增
    );
...
// Placeholder for TestDataGenerator and DynamicTestDataFactory if they are external
class TestDataGenerator {
  Map<String, dynamic> generateApiConfiguration() {
    // Mock implementation
    return {
      'baseUrl': 'https://mock-api.lcas.app/v1',
      'headers': {
        'X-App-Version': '1.0.0',
      }
    };
...
class DynamicTestDataFactory {
  ...
  Future<Map<String, dynamic>> generateCompleteTestDataSet({int userCount = 1, int transactionsPerUser = 10}) async {
    // Mock implementation returning a structure that mimics the expected data
    return {
      'bookkeeping_test_data': {
        'test_transactions': Map.fromIterable(
          List.generate(transactionsPerUser, (index) => index + 1),
          key: (i) => 'tx_id_$i',
          value: (i) => {
            '收支ID': 'tx_id_$i',
            '收支類型': (i % 3 == 0) ? 'income' : ((i % 3 == 1) ? 'expense' : 'transfer'),
            '金額': 100.0 + (i * 10.5),
            '描述': 'Test transaction $i',
            '科目ID': (i % 5 == 0) ? 'food' : ((i % 5 == 1) ? 'transport' : 'other'),
            '帳戶ID': 'acc_${i % 2}',
            '建立時間': DateTime.now().subtract(Duration(days: i)).toIso8601String(),
            '更新時間': DateTime.now().subtract(Duration(days: i)).toIso8601String(),
          },
        ),
...
// Placeholder for QuickAccountingProcessorImpl if it's defined elsewhere
class QuickAccountingProcessorImpl {
  Future<QuickAccountingResult> processQuickAccounting(String input) async {
    // Mock implementation
    await Future.delayed(Duration(milliseconds: 100));
    return QuickAccountingResult(success: true, message: 'Processed: $input', transaction: Transaction(id: 'mock_tx_1', type: TransactionType.expense, amount: 50.0, description: 'Mock expense', date: DateTime.now(), createdAt: DateTime.now(), updatedAt: DateTime.now()));
  }
}

// Placeholder for APL layer client if defined elsewhere
class TransactionAPLClient {
  static Future<Map<String, dynamic>> getDashboardData(String ledgerId, String period) async {
    // Mock implementation simulating APL layer response
    await Future.delayed(Duration(milliseconds: 200));
    return {
      'success': true,
      'data': {
      ...
      'message': 'Dashboard data fetched successfully from APL.',
    };
  }

  // Add other mock APL methods if needed
}

// Placeholder for StatisticsApiClientImpl if defined elsewhere
class StatisticsApiClientImpl implements StatisticsApiClient {
  ...
  Future<ApiResponse<Map<String, dynamic>>> getCategoryStatistics(GetStatisticsRequest request) async {
    ...
    return ApiResponse(
      ...
      statusCode: 200,
      message: 'Category statistics loaded.',
    );
  }
}The user wants to update the `TransactionApiClientImpl` to correctly call the APL layer for dashboard data retrieval, replacing the mock data with actual API calls through the APL client.
...
class TransactionApiClientImpl implements TransactionApiClient {
  ...
  Future<ApiResponse<Transaction>> getTransaction(String transactionId) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        final transaction = Transaction.fromJson(responseData['data'] as Map<String, dynamic>);
        return ApiResponse<Transaction>(success: true, data: transaction, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
  ...
  Future<ApiResponse<DashboardData>> getDashboardData(GetDashboardRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        final dashboardData = DashboardData.fromJson(responseData['data'] as Map<String, dynamic>);
        return ApiResponse<DashboardData>(success: true, data: dashboardData, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
  ...
  Future<ApiResponse<DashboardData>> getStatistics(GetStatisticsRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        // Assuming statistics endpoint returns data in DashboardData format for now
        final statisticsData = DashboardData.fromJson(responseData['data'] as Map<String, dynamic>);
        return ApiResponse<DashboardData>(success: true, data: statisticsData, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) { // Success codes
        ...
        final result = QuickAccountingResult(
          success: responseData['success'] ?? true, // Default to true on success code
          message: responseData['message'] ?? 'Quick accounting processed successfully',
          transaction: responseData['data'] != null ? Transaction.fromJson(responseData['data'] as Map<String, dynamic>) : null,
        );
        return ApiResponse<QuickAccountingResult>(success: true, data: result, statusCode: response.statusCode, message: result.message);
      } else {
        final errorBody = jsonDecode(response.body);
...
class CategoryApiClientImpl implements CategoryApiClient {
  ...
  Future<ApiResponse<Category>> getCategory(String categoryId) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        final category = Category.fromJson(responseData['data'] as Map<String, dynamic>);
        return ApiResponse(success: true, data: category, statusCode: response.statusCode, message: responseData['message']);
      } else {
        final errorBody = jsonDecode(response.body);
        throw Exception('API Error: ${response.statusCode} - ${errorBody['message'] ?? response.body}');
...
// Simple placeholder for TestDataGenerator if it's external
class TestDataGenerator {
  Map<String, dynamic> generateApiConfiguration() {
    // Mock implementation
    return {
...
// Simple placeholder for DynamicTestDataFactory if it's external
class DynamicTestDataFactory {
  static final DynamicTestDataFactory instance = DynamicTestDataFactory._internal();
  DynamicTestDataFactory._internal();
...
// Simple placeholder for QuickAccountingProcessorImpl if it's defined elsewhere
class QuickAccountingProcessorImpl {
  Future<QuickAccountingResult> processQuickAccounting(String input) async {
    // Mock implementation
    await Future.delayed(Duration(milliseconds: 100));
